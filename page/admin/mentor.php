                ...
                <div class="col-lg-7 ustify-content-start mt-2 mt-lg-0 ">
                  <div class="row d-flex justify-content-start">
                    ...
                    <div class="col-lg-12 d-flex justify-content-between">
                      ...
                      <input type="text" class="form-control me-2" id="inputEmail4" name="mentor" placeholder="Masukan nama mentor">

                      <button class="btn btn-primary btn-md d-flex justify-content-between" type="submit" name="cari">
                        <span class="me-2"><i class='bx bx-search'></i></span>
                        Cari</button>
                      <!-- Btn refresh -->
              ...
              <?php foreach ($mentor as $row) : ?>
                <tr>
                  ...
                  <td class="text-center">
                    <img src="../../Assets/<?= $row["foto"] ?>" alt="Profil Mentor" class="rounded img-fluid w-50" />
                  </td>
                  <td class="text-start">
                    <?= $row["nama_mentor"] ?>
                  </td>
